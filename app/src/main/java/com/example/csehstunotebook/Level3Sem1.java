    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cse303.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("ls","l3s1");
                intent.putExtra("course","cse303");
