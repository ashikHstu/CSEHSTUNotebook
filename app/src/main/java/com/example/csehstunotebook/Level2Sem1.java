    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cse201.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("ls","l2s1");
                intent.putExtra("course","cse201");
