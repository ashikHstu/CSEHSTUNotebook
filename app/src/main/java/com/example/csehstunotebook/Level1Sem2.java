    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cse151.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("ls","l1s2");
                intent.putExtra("course","cse151");
